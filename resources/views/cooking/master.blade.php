...
<html>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('/css/cooking.css') }}">
    ...
    <body>
        <div class="frame" id="n3_0">
            ...
            <p>
            <!-- image 1 -->
            <img id="n4_3" src="{{ asset('/img/Cooking Atas.png') }}" height="230" ></img>
            </p>

            @yield("content")
            <div>
            <!-- image 2 -->
            <img id="n4_4" src="{{ asset('/img/Cooking Bawah.png') }}" height="230" ></img>
            </div>
        </div>
        <!-- Rectangle 1 -->
